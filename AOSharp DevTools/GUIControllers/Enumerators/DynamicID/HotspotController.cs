...
namespace DevTools.GUIControllers.Enumerators.DynamicID
{
    public class HotspotController : DynamicIDController
    {
        ...
        public HotspotController(String PluginDirectory, AOSharp.Core.Settings PluginSettings) : base(PluginDirectory, PluginSettings, DynamicIdDisplayType.Text, "Hotspot", "HOTSPOT_", 0, 796)
        {

...
namespace DevTools.GUIControllers.Enumerators.DynamicID
{
    public class CommandController : DynamicIDController
    {
        ...
        public CommandController(String PluginDirectory, AOSharp.Core.Settings PluginSettings) : base(PluginDirectory, PluginSettings, DynamicIdDisplayType.Text, "Command", "COMMAND_", 0, 796)
        {
